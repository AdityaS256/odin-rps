...
function display (playerChoice, computerChoice, gameResult)
{
    ...
    comp.innerHTML = '<svg id="thinking" xmlns="http://www.w3.org/2000/svg" height="128" viewBox="0 0 512 512"><style>svg{fill: rgba(255, 255, 255, 0.15)}</style><path d="M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z"/></svg>'
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {                
                ...
                else if (gameResult === true)
                {
                    ...
                    setTimeout(() => {
                        usrpoints.classList.remove('win');
                    }, 500);

                    usrpoints.classList.add('win');
                ...
                else if (gameResult === false)
                {
                    ...
                    setTimeout(() => {
                        compoints.classList.remove('lose');
                    }, 500);

                    compoints.classList.add('lose');
